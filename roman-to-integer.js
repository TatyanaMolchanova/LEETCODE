let romanToInt = function(s) {
    ...
    for (let i = 0; i < string.length; i++) {
        ...
        if ((string[i] + string[i + 1]) === 'IV') {
        ...
        } else if ((string[i] + string[i + 1]) === 'IX') {
            console.log('i', i)
            res += 9;
            string.splice(i, 2)
            // i = i - 1;
            console.log('2 res', res)
            console.log('2 string', string)
        } else if ((string[i] + string[i + 1]) === 'XL') {
            console.log('i', i)
            res += 40;
            string.splice(i, 2)
            // i = i - 1;
        ...
        } else if ((string[i] + string[i + 1]) === 'XC') {
            console.log('i', i)
            res += 90;
            string.splice(i, 2)
            // i = i - 1;
            console.log('3 res', res)
            console.log('3 string', string)
        } else if ((string[i] + string[i + 1]) === 'CD') {
            console.log('i', i)
            res += 400;
            string.splice(i, 2)
            // i = i - 1;
        ...
        } else if ((string[i] + string[i + 1]) === 'CM') {
            console.log('i', i)
            res += 900;
            string.splice(i, 2)
            i = i;
